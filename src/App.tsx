...
const NAV_LINKS = ["Inicio", "Académico", "Programación", "Actividades", "Noticias", "Contacto"];
      ...
      <header className="sticky top-0 z-50 bg-[#274C77] text-white">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            <img src='"@\src\assets\Logo_Tecnica-sin_fondo.png";' alt="Logo PRoA" className="h-10 w-10 object-contain" />
            <div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="relative rounded-sm overflow-hidden bg-[#0d1b2a] h-full min-h-[420px] flex flex-col justify-between">
            ...
            <div className="relative p-8 flex-1 flex flex-col justify-end">
              <div className="mb-6">
                <img src='"@\src\assets\Logo_Tecnica-sin_fondo.png";' alt="Logo PRoA" className="h-20 w-20 object-contain opacity-90" />
              </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {MATERIAS.map((m, i) => (
            ...
            >
              ...
              <span
                className={`mb-4 block ${m.mono ? "font-mono-code text-[#274C77] text-2xl font-bold" : "text-3xl"}`}
              >
                {m.icono}
              </span>
