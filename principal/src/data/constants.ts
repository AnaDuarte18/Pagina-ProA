...
export const CODE_SNIPPET = `def bienvenida(nombre):
...
export const ASIGNATURA_COLORS: Record<string, string> = {
...
export const CLASIFICACIONES = ["Todas", "Pedagógico", "Lectura"];
