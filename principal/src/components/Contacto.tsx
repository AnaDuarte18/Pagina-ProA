export default function Contacto() {
  return (
    <div className="bg-[#E7ECEF] min-h-[calc(100vh-4rem)] py-12 px-6 flex justify-center items-start">
      <div className="max-w-5xl w-full mx-auto">
        {/* Cabecera de Contacto */}
        <div className="bg-[#274C77] text-white rounded-t-xl p-8 md:p-12 shadow-md text-center">
        ...
        {/* Contenido principal centrado con dos columnas equilibradas */}
        <div className="bg-white rounded-b-xl p-8 md:p-12 shadow-lg border-x border-b border-[#8B8C89]/20 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          {/* Columna 1: Medios de Contacto */}
