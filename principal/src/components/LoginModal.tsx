...
export default function LoginModal() {
  ...
  // Redirección OAuth estándar como alternativa
          ...
          <div className="flex flex-col items-center justify-center min-h-[48px] gap-3">
            {loading ? (
              ...
              <>
                ...
                <div ref={googleButtonRef} className="flex justify-center w-full min-h-[40px]" />

                {/* Botón personalizado estilizado con logo oficial de Google */}
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="w-full max-w-[320px] flex items-center justify-center gap-3 px-4 py-2.5 border border-slate-300 rounded hover:bg-slate-50 hover:border-slate-400 transition-colors shadow-xs text-sm font-medium text-slate-700"
                >
